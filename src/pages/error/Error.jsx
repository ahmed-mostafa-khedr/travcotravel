...
import ErrorIcon from "./56-warning-outline.gif";
import "./error.css";
  ...
  return (
    <Box
      sx={{
        ...
        alignItems: "center",
        height: "100vh",
        backgroundImage: "linear-gradient(180deg, #ccc, #fff,#fff)",
        overflow: "hidden",
      }}
    >
      <div className="contact_header text-center">
        <h1
          ...
          style={{
            ...
            fontWeight: "bold",
            color: "#e60000",
            textShadow: "rgb(0, 0,0,  25%) 0px 3px 6px",
        ...
        <svg
          ...
          width="252.522"
          height="9.046"
          viewBox="0 0 252.522 9.046"
          style={{ bottom: "20px", position: "relative", width: "150px" }}
        >
          <g id="line---" transform="translate(-787 -1157.477)">
            <path
              id="Path_37708"
              data-name="Path 37708"
              d="M0,0H168.5"
              transform="translate(787 1162)"
              fill="none"
              stroke="#e60000"
              strokeWidth="2"
            />
            ...
            <circle
              ...
              cy="3.523"
              r="3.523"
              transform="translate(956.477 1158.477)"
              fill="none"
              stroke="#e60000"
              strokeWidth="2"
            />
            <circle
              ...
              cy="3.523"
              r="3.523"
              transform="translate(993.477 1158.477)"
              fill="none"
              stroke="#e60000"
              strokeWidth="2"
            />
            <circle
              ...
              cy="3.523"
              r="3.523"
              transform="translate(1031.477 1158.477)"
              fill="none"
              stroke="#e60000"
              strokeWidth="2"
            />
      ...
      <Container maxWidth="md" className="mt-5 pt-5">
        <Grid container className="align-items-center" spacing={2}>
          <Grid xs={6}>
            <Typography
              variant="h3"
              sx={{ color: "#e60000", fontFamily: "inherit" }}
            >
              <i className="fa-solid fa-triangle-exclamation"></i> 404 Not Found
            </Typography>
            <Typography
              variant="h6"
            ...
            >
              The page you’re looking for doesn’t exist ! Just kidding. Please
              make sure you've entered the correct address, or return to :
            </Typography>
          ...
          <Grid xs={6}>
            <svg
              ...
              y="0px"
              width="206.5px"
              viewBox="0 0 326.5 592"
              style={{ enableBackground: "new 0 0 326.5 592" }}
              space="preserve"
            >
              <defs></defs>
              <g id="shadow_1_">
                <image
                  ...
                  width="192"
                  height="103"
                  href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAMAAAABnCAYAAABWxU1RAAAACXBIWXMAAAsSAAALEgHS3X78AAAA
       ...
       trSlLW1pS1va0pb2j9T+R4ABAOgiAP26ckJ4AAAAAElFTkSuQmCC"
              ...
              <g id="robot_1_">
                <path
                  className="st0"
                  d="M152.7,89.2h-0.1v21.4h19.6V89.8c6.8-3.4,11.4-10.4,11.4-18.5c0-11.5-9.2-20.8-20.6-20.8
           c-11.4,0-20.6,9.3-20.6,20.8C142.4,79,146.6,85.6,152.7,89.2z"
                />
                <path
                  className="st0"
                  d="M162.2,466c23.3,0,43.1-14.9,50.6-35.8H111.5C119.1,451.1,138.9,466,162.2,466z"
                />
                <g>
                  <path
                    className="st0"
                    d="M159.1,356c1,0.9,2.4,1.3,4.2,1.3c1.8,0,3.2-0.6,4.5-1.9c1.2-1.2,1.8-2.7,1.8-4.4v-21.4l-12.5,22.4
             C157.4,353.8,158.1,355.1,159.1,356z"
                  />
                  <polygon
                    className="st0"
                    points="213.7,338.4 213.7,314.8 194.8,338.4    "
                  />
                  <path
                    className="st0"
                  ...
                  <path
                    className="st0"
                    d="M283.5,262.5v-42.8c0,0-4.2-78-68.6-102.3c-19.1-7.2-36.6-10.1-51.7-10.7c-15.1,0.5-32.6,3.5-51.7,10.7
             ...
             c12.7,0.2,45,4.3,66.6,23c22.2,19.3,22.2,51,22.2,51C253.2,240.6,231,242.4,231,242.4z"
                  ...
                  <polygon
                    className="st0"
                    points="112.9,338.4 112.9,314.8 94,338.4     "
                  />
                </g>
                <g id="light_1_">
                  <image
                    style={{ overflow: "visible", opacity: "0.83" }}
                    width="142"
                    height="143"
                    href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAI4AAACPCAYAAAAsoeOtAAAACXBIWXMAAAsSAAALEgHS3X78AAAA
       ...
       dtttt91222233Xbbbbfddtttt9122+3L2z8CDAAGA9CHeMiJOgAAAABJRU5ErkJggg=="
                    transform="matrix(1 0 0 1 92.2048 0)"
                  ></image>
                  <g>
                ...
                <path
                  id="leftArm_1_"
                  className="st0"
                  d="M32.8,388.4v-95.1c0-5-4-9-9-9H19c-5,0-9,4-9,9v95.1c-6,3.8-10,10.5-10,18.1
           c0,11.8,9.6,21.4,21.4,21.4s21.4-9.6,21.4-21.4C42.8,398.8,38.8,392.2,32.8,388.4z"
                />
                <path
                  id="rightArm_1_"
                  className="st0"
                  d="M316.6,388.4v-95.1c0-5-4-9-9-9h-4.8c-5,0-9,4-9,9v95.1c-6,3.8-10,10.5-10,18.1
